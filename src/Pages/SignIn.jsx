    ...
    <div className='flex flex-col justify-center items-center w-full my-2' >
      <div className='w-1/3 mx-1/2 '>
        ...
        <div className='rounded w-full text-center shadow-xl border'>
          ...
          <h1 className='font-bold text-3xl p-10 text-cente'>Welcome Back!</h1>
          <h4 className='sign text-lg p-2 text-center'>Sign in into your account for full access</h4>
          <div className='mx-5'>
            <form action="" method="post" >
              <div className='p-2'>
                <input type="email" name="" id="" className='w-full p-3 rounded-full outline-none ' autoFocus placeholder='Your email address' />
              </div>
