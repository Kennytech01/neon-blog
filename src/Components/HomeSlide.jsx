            ...
            return (
              <div key={item.details} className="carousel-item h-[30vh]  m-1 inline-flex  items-center justify-center">
                ...
                <div className="md:w-[100%] h-[100%] whitespace-normal flex flex-col justify-evenly">
                  ...
                  <h1 className="lg:text-4xl text-2xl hover:cursor-pointer sm:py-3 px-3 font-bold hover:underline decoration-[#EC094D] decoration-2 underline-offset-4">{item.header}</h1>
                  <h3 className="tracking-wide p-3 text-stone-600 detail font-normal ">{item.details}</h3>
                ...
                {/* picture Display */}
                <div className="hidden sm:flex h-[90%] w-full p-2 order-first md:order-2">
